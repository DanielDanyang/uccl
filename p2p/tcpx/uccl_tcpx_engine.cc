...
// NOTE(TCPX): RDMA-specific engine creation relying on uccl::RDMAEndpoint.
// TODO(TCPX): Replace with TCPX endpoint creation
uccl_engine_t* uccl_engine_create(int local_gpu_idx, int num_cpus) {
  // TODO(TCPX): Create TcpxEndpoint instead of RDMA Endpoint
  /*
  ...
  */
  ...
  // TCPX implementation placeholder:
  return nullptr;  // TODO: Implement TCPX engine creation
}
...
// NOTE(TCPX): RDMA-based connect path; uses libibverbs resources.
// TODO(TCPX): Replace with TCPX connection establishment
uccl_conn_t* uccl_engine_connect(uccl_engine_t* engine, char const* ip_addr,
  ...
  */
  ...
  // TCPX implementation placeholder:
  return nullptr;  // TODO: Implement TCPX connect using tcpxConnect_v5
}

// NOTE(TCPX): RDMA-based accept path; not usable in TCPX-only mode.
// TODO(TCPX): Replace with TCPX accept implementation
uccl_conn_t* uccl_engine_accept(uccl_engine_t* engine, char* ip_addr_buf,
  ...
  */
  ...
  // TCPX implementation placeholder:
  return nullptr;  // TODO: Implement TCPX accept using tcpxAccept_v5
}

// NOTE(TCPX): RDMA memory registration wrapper.
// TODO(TCPX): Replace with TCPX memory registration using regMr
uccl_mr_t* uccl_engine_reg(uccl_engine_t* engine, uintptr_t data, size_t size) {
  ...
  */
  ...
  // TCPX implementation placeholder:
  return nullptr;  // TODO: Implement TCPX memory registration using regMr
}
...
// NOTE(TCPX): RDMA send path using registered memory.
// TODO(TCPX): Replace with TCPX send using isend
int uccl_engine_write(uccl_conn_t* conn, uccl_mr_t* mr, void const* data,
  ...
  */
  ...
  // TCPX implementation placeholder:
  return -1;  // TODO: Implement TCPX send using isend
}

// NOTE(TCPX): RDMA receive path using registered memory.
// TODO(TCPX): Replace with TCPX receive using irecv
int uccl_engine_recv(uccl_conn_t* conn, uccl_mr_t* mr, void* data,
  ...
  */
  ...
  // TCPX implementation placeholder:
  return -1;  // TODO: Implement TCPX receive using irecv
}

// NOTE(TCPX): RDMA transfer status polling.
// TODO(TCPX): Replace with TCPX transfer status polling using test
bool uccl_engine_xfer_status(uccl_conn_t* conn, uint64_t transfer_id) {
  ...
  */
  ...
  // TCPX implementation placeholder:
  return false;  // TODO: Implement TCPX transfer status polling using test
}
...
// NOTE(TCPX): RDMA connection teardown.
// TODO(TCPX): Replace with TCPX connection cleanup using closeSend/closeRecv
void uccl_engine_conn_destroy(uccl_conn_t* conn) {
  if (conn) {
    ...
    */
    ...
    // TCPX implementation placeholder:
    // TODO: Implement TCPX connection cleanup using closeSend/closeRecv
    delete conn;
  }
}

// NOTE(TCPX): RDMA memory deregistration wrapper.
// TODO(TCPX): Replace with TCPX memory deregistration using deregMr
void uccl_engine_mr_destroy(uccl_mr_t* mr) {
  ...
  */
  ...
  // TCPX implementation placeholder:
  // TODO: Implement TCPX memory deregistration using deregMr
  delete mr;
}

// Helper function for the listener thread
void listener_thread_func(uccl_conn_t* conn) {
  size_t const buffer_size = 4096;  // 4KB buffer for receiving messages
...
// NOTE(TCPX): RDMA metadata construction (IP/port from RDMA endpoint).
// TODO(TCPX): Replace with TCPX metadata construction using real IP and TCPX
// device info
int uccl_engine_get_metadata(uccl_engine_t* engine, char** metadata) {
  ...
  */
  ...
  // TCPX implementation placeholder:
  return -1;  // TODO: Implement TCPX metadata construction with real IP and
              // device info
}